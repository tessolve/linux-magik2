...
static void __init imx6q_lcd_blk_init(void)
{
	gpio_request(MAGIK2_Q7_LCD_BKL, "lcd_bkl");
	gpio_request(MAGIK2_Q7_LCD_BKL2, "lcd_bkl1");
   // 	gpio_direction_output(MAGIK2_Q7_LCD_BKL, 1);
//	gpio_direction_output(MAGIK2_Q7_LCD_BKL2, 1);
	gpio_free(MAGIK2_Q7_LCD_BKL);
	gpio_free(MAGIK2_Q7_LCD_BKL2);
}
